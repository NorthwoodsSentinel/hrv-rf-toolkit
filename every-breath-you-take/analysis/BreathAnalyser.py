...
class BreathAnalyser:
    ...
    def __init__(self):
        ...
        self.BR_ACC_HIST_SIZE = 20000 # Up to 33 minutes at 10 Hz (increased for longer sessions)
    ...
    def update_chest_acc(self, time, acc):
        ...
        # Subsampling for Polar (200 Hz → 10 Hz to prevent buffer overflow)
        if self.sensor_class == "PolarH10Client" or self.sensor_class == "SmartBelt":
